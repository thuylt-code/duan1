...
public class ViewQuanLy extends javax.swing.JFrame {
    ...
    private MenuBanHang menuBanHang;
    ...
    private void switchToMenuBanHang() {
        if (menuBanHang != null) {
            menuBanHang.closeWebcam(); // Đóng webcam trước khi chuyển giao diện
        }
        menuBanHang = new MenuBanHang();
        // Thêm menuBanHang vào JFrame hoặc JPanel
        setContentPane(menuBanHang);
        revalidate();
        repaint();
    }
    ...
    private void initComponents() {
        ...
        imageAvatar1.setImage(new javax.swing.ImageIcon(getClass().getResource("/icon/10.png"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(51, 51, 51));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("CRYSTAL SHOP");
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        // TODO add your handling code here:   
        MenuSanPham mbh = new MenuSanPham();
        jDesktopPane1.removeAll();
        jDesktopPane1.add(mbh).setVisible(true);
        if (menuBanHang != null) {
            menuBanHang.closeWebcam(); // Đóng webcam khi chuyển giao diện
        }
        menuBanHang = new MenuBanHang();
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        // TODO add your handling code here:
        MenuVoucher msp = new MenuVoucher();
        jDesktopPane1.removeAll();
        jDesktopPane1.add(msp).setVisible(true);
        if (menuBanHang != null && menuBanHang.getWebcam().isOpen()) {
            menuBanHang.getWebcam().close();
        }
        menuBanHang = new MenuBanHang();
