...
//    }
    ...
    private void loadGioiTinh(List<NhanVienResp> list) {
        ...
        for (NhanVienResp gt : list) {
            String gender = gt.getGioiTinh() ? "Nam" : "Nữ";
...
//    }
    public void fillTableDangLam(List<NhanVienResp> lists) {
        ...
        lists.forEach(s -> defaultTableModel.addRow(new Object[]{
            ...
            s.getLuong(), s.getSdt(), s.getEmail(), s.getDiaChi(),
            s.getNgaySinh(), s.getGioiTinh() == true ? "Nam" : "Nữ", s.getNgayBatDau(), s.getMatKhau(),
...
//        return nv;
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(73, 73, 73)
                                .addComponent(txtLuong, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void cbxLocVaiTroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxLocVaiTroActionPerformed
        ...
        defaultTableModel.setRowCount(0);
        try {
            String a = (String) cbxGioiTinh.getSelectedItem();
            cv = (ChucVu) cbxLocVaiTro.getSelectedItem();

            List<NhanVienResp> list = repo.loc(cv.getId(), "Nữ".equals(a) ? 0 : 1);
